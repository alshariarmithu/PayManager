      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-shadow font-medium"
          >
